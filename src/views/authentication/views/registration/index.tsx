    ...
    return (
        <ScrollView style={styles.container} keyboardDismissMode='interactive' keyboardShouldPersistTaps={'handled'}>
            <View style={styles.inputsContainer}>
                ...
                <CustomTextInput keyboardType={'numeric'} value={pin} onChangeText={(text: string) => updateField('pin', text)} placeholder={'pin'} isDark={false} testID='inputPinRegistrationView' />
                <CustomTextInput value={phone} onChangeText={(text: string) => updateField('phone', text)} placeholder={'phone'} isDark={false} testID='inputLoginRegistrationView' />
                <CustomTextInput value={email} onChangeText={(text: string) => updateField('email', text)} placeholder={'email'} isDark={false} testID='inputImailRegistrationView' />
            </View>
            <View style={styles.mainButtonContainer}>
                <MainButton testID='buttonRegistrateRegistrationView' onPress={() => handleRegistrate(navigation)} title={'save'} disabled={disabled} inProgress={inProgress} />
            </View>
        </ScrollView>
    )
});
